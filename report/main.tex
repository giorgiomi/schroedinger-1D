...
\begin{align*}
    &\langle K \rangle = \langle \psi(x,t) | K | \psi(x,t) \rangle = \int_{-L}^{L} \psi^*(x,t) \left(-\frac{1}{2}\pdv[2]{x}\right)\psi(x,t) \dd x\, , \\
    &\langle V \rangle = \langle \psi(x,t) | V | \psi(x,t) \rangle = \int_{-L}^{L} \psi^*(x,t) V(x) \psi(x,t) \dd x = \int_{-L}^{L} V(x) |\psi(x,t)|^2 \dd x\, .
\end{align*}
In figura si nota che l'energia, entro un piccolo scarto, è conservata nel tempo.
